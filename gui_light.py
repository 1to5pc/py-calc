...
if __name__ == "__main__":
    ...
    button_style = {"fg": "black", "bg": "white", "font": ("Arial", 14), "height": 2, "width": 7, "bd": 5}
    ...
    # Create Clear button
    clear_button = Button(gui, text="Clear", command=clear, fg="red", bg="white", font=("Arial", 14), height=2, width=7, bd=5)
    clear_button.grid(row=5, column=0, columnspan=2, padx=5, pady=5)

    # Create Equal button
    equal_button = Button(gui, text="=", command=equalpress, fg="black", bg="white", font=("Arial", 14), height=2, width=7, bd=5)
